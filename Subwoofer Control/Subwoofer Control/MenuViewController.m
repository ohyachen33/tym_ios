...
enum{
    FeaturesVolume = 0,
    FeaturesLowPassFilter,
    FeaturesPhase,
    FeaturesPolarity,
    FeaturesParametricEqualizer,
    FeaturesRoomGainCompensation,
...
- (void)viewDidLoad {
    ...
    self.menuItemTitles = @[@[@"Discover..."], @[@"Volume", @"Low Pass Filter", @"Phase", @"Polarity", @"Parametric EQ", @"Room Gain Compensation"], @[@"System Settings", @"OTA", @"About"]];
...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    {
        self.pedalCaseViewController = [[UIStoryboard storyboardWithName:@"iPhone" bundle:NULL] instantiateViewControllerWithIdentifier:@"PedalCaseViewController"];
    ...
    switch ([indexPath section]) {
        ...
        case GroupFeatures:
        {
            switch ([indexPath row]) {
                ...
                case FeaturesVolume:
                {
                    ...
                    break;
                case FeaturesLowPassFilter:
                {
                    [self.pedalCaseViewController addPedalViewControllerByString:@"LowPassFilterPedalViewController"];
                    [self.pedalCaseViewController panBack];
                }
                    break;
                case FeaturesPhase:
                {
                    ...
                    break;
                case FeaturesPolarity:
                {
                    [self.pedalCaseViewController addPedalViewControllerByString:@"PolarityPedalViewController"];
                    [self.pedalCaseViewController panBack];
                }
                    break;
                case FeaturesParametricEqualizer:
                {
                    [self.pedalCaseViewController addPedalViewControllerByString:@"ParametricEQViewController"];
                    [self.pedalCaseViewController panBack];
                }
                    break;
                case FeaturesRoomGainCompensation:
                {
                    [self.pedalCaseViewController addPedalViewControllerByString:@"RGCPedalViewController"];
                    [self.pedalCaseViewController panBack];
                }
                    break;
                default:
        ...
        case GroupSettings:
        {
            switch ([indexPath row]) {
                ...
                case SettingsOTA:
                {
                    [self.pedalCaseViewController addPedalViewControllerByString:@"OTAViewController"];
                    [self.pedalCaseViewController panBack];
                }
                    break;
                case SettingsAbout:
