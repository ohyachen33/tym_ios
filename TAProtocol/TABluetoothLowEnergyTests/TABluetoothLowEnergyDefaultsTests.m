//
//  TABluetoothLowEnergyDefaultsTests.m
//  TAProtocol
//
...
@interface TABluetoothLowEnergyDefaultsTests : XCTestCase

@end

@implementation TABluetoothLowEnergyDefaultsTests

- (void)setUp {
    [super setUp];
    // Put setup code here. This method is called before the invocation of each test method in the class.
    [[TABluetoothLowEnergyDefaults sharedDefaults] createDefault:kDEFAULT];
}
...
- (void)testServiceUuids {
    ...
    NSArray* uuids = [[TABluetoothLowEnergyDefaults sharedDefaults] serviceUuids];
...
- (void)testCharacteristicUuidsOfServiceUuid {
    ...
    NSArray* uuids = [[TABluetoothLowEnergyDefaults sharedDefaults] characteristicUuidsOfServiceUuid:@"7D24"];
...
- (void)testServiceUuidFromCharacteristicUuid{
    ...
    NSString* serviceUuid = [[TABluetoothLowEnergyDefaults sharedDefaults] serviceUuidFromCharacteristicUuid:@"5345"];
    
    XCTAssertEqual([serviceUuid isEqualToString:@"7D24"], YES);
    
    serviceUuid = [[TABluetoothLowEnergyDefaults sharedDefaults] serviceUuidFromCharacteristicUuid:@"4000"];
